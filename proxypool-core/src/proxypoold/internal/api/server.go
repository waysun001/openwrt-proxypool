...
var defaultMethods = map[string]struct{}{
	"status.get": {}, "node.save": {}, "node.delete": {}, "node.action": {}, "device.list": {}, "device.bind": {}, "device.unbind": {}, "device.bindings.replace": {}, "import.preview": {}, "import.commit": {}, "job.get": {}, "job.list": {}, "system.activate": {}, "system.events": {}, "system.interface_event": {}, "diagnostics.create": {}, "diagnostics.get": {}, "diagnostics.claim": {}, "diagnostics.release": {},
}
